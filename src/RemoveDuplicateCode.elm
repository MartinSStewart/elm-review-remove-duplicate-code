...
A heuristic is used to estimate when some code has been copied too many times.
A long block of code copied 3 times might get reported while a very short piece of code might not get reported even when copied hundreds of times.
